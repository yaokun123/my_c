...
void print_register(){
    printf("rax = %16llx\trbx = %16llx\trcx = %16llx\t rdx = %16llx\t", reg.rax, reg.rbx, reg.rcx, reg.rdx);
    printf("rsi = %16llx\trdi = %16llx\trbp = %16llx\t rsp = %16llx\trip = %16llx\n", reg.rsi, reg.rdi, reg.rbp, reg.rsp, reg.rip);
}
